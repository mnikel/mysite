...
export const homeData = {
  ...
  title1: "But... you can call me Nigel.",
  title2: "I'm",
  title3: "Tech passionate...",
  title4: "Revisiting my youthful drive to blog..",
  title5: "Yes. In 2023.",
  title6: "Scrum Master wannabe, since OCD has to be treated somehow, right?",
  title7: "Nothing better than the SCRUM framework to do that.",
...
export const ResumeData = [
  {
    title: "August 2023 -",
    cardTitle: "Figured out what I actually want to do",
    cardSubtitle: "Scrum Master wannabe",
    cardDetailedText: [
      "1. Memorizing SCRUM Guide.",
      "2. Understanding people better.",
      "3. Looking for a company to take me as a Padawan learner.",
    ],
  },
  {
    title: "August 2023 -",
    cardTitle:
      "Getting new job, since ice with raspberry juice in not sufficent calories intake: Raben Logistics",
    cardSubtitle: "Warehouse Worker / Forklift Driver",
    cardDetailedText: [
      "1. Order picking using forklifts (Toyota and Crown)",
      "2. Inserting pallets into system racks.",
      "3. Working with a scanner and imho poorly written WMS system. ",
    ],
  },
  {
    title: "April 2022 - August 2023",
    cardTitle: "Diving deeper into learning JavaScript",
    cardSubtitle: "Fullstack Developer Wannabe",
    cardDetailedText: ["1.", "2.", "3.", "4."],
  },
  {
    title: "June 2021 - April 2022",
    cardTitle: "Rohlig Suus Logistics",
    cardSubtitle: "Warehouse worker / Forklift Driver",
    cardDetailedText: [
      "1. Order picking using forklifts (Jungheinrich: EKX, EKS, ETV, ERE)",
      "2. QA and distribution process",
      "3. Unloading / loading trucks using forklifts (Jungheinrich: EFG, ERE) ",
      "4. Working with a scanner and WMS",
    ],
  },
  {
    title: "September 2020 - June 2021",
    cardTitle: "Life is a novel, and novels are complicated",
    cardSubtitle: "Long, long time ago I had a blank spot in my resume...",
    cardDetailedText: "That blank spot is really not your business.",
  },
  {
    title: "July 2020 - September 2020",
    cardTitle: "DAPS",
    cardSubtitle: "Warehouse worker / Forklift Driver",
    cardDetailedText: [
      "1. Order picking using really old forklifts",
      "2. Warehouse cleaning",
      "3. QA",
      "4. Unloading / loading trucks using really old forklifts",
    ],
  },

  {
    title: "December 2019 - June 2020",
    cardTitle: "Life is a novel, and novels are complicated",
    cardSubtitle: "Even longer time ago, I had a blank spot in my resume",
    cardDetailedText: "That one is also not your business.",
  },
  {
    title: "October 2019 - November 2019",
    cardTitle: "Midocean Logistics",
    cardSubtitle: "Warehouse worker",
    cardDetailedText: [
      "1. Order picking using hand driven forklifts",
      "2. Warehouse cleaning",
      "3. QA",
    ],
  },
  {
    ...
    cardTitle: "Archidoc S.A",
    cardSubtitle: "Data Logger",
    cardDetailedText: [
      "1. Logging data from old electricity contracts",
      "2. Office work",
      "3. Office cleaning",
    ],
  },
  {
    title: "May 2018",
    cardTitle: "Masters",
    cardSubtitle: "Finished my masters degree in Media Culture",
    cardDetailedText: [
      "1. Spending two years of my life for nothing",
    ],
  },
  {
    title: "May 2018 - September 2018",
    cardTitle: "Boys and Girls Clubs of San Francisco",
    cardSubtitle: "Maintenance worker / Driver / Nightwatch",
    cardDetailedText: [
      "1. Maintenance work",
      "2. Housecleaning",
      "3. Laundry",
      "4. Dishwashing",
      "5. Waiter on special events",
      "6. Driving company vans, buses, and trucks",
      "7. Night security"
    ],
  },
  {
    title: "June 2017 - September 2017",
    cardTitle: "Boys and Girls Clubs of San Francisco",
    cardSubtitle: "Maintenance worker",
    cardDetailedText: [
      "1. Maintenance work",
      "2. Housecleaning",
      "3. Laundry",
  ...
  },
  {
    title: "June 2016",
    cardTitle: "Bachelor",
    cardSubtitle: "Finished my bachelor degree in Cultural Antropology",
    cardDetailedText: [
      "1. Spending three years of my life for nothing, just to satisfy some degree fetish",
    ],
  },

  {
    title: "July 2014 - September 2014",
    cardTitle: "Polish Press Agency",
    cardSubtitle: "Intern",
    cardDetailedText: [
      "1. Learning how to write news agency dispatches",
      "2. Travelling around to get the story from the source",
      '3. Learning how to write concise texts'
    ],
  },
  {
    title: "25 September 1990",
    cardTitle: "Soul taking the blue pill and escaping the Matrix",
    cardSubtitle: "Reincarnation as Marcin",
    cardDetailedText: [
      "1. Learning how to live",
      "2. Learning..",
      '3. Still learning to this day and its 2023..'
    ],
  },
];